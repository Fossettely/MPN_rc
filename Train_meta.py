...
# meta setting
parser.add_argument('--task_size', type=int, default=1, help='task size for meta training, 1 for meta training, the others for meta validation') #default =4
parser.add_argument('--segs', type=int, default=32, help='number of segs when dividing the videos for meta training')
parser.add_argument('--meta_base', type=str, default='exp/ped2/bn_LrShedule/ped2_model_1000.pth', help='file path of resume pth')
