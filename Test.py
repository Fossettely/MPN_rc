...
parser.add_argument('--model_dir',default = './exp/ped1/bn_LrShedule/model_1000.pth' ,type=str, help='directory of model')
...
print('The result of Version {0} Epoch {1} on {2}'.format(args.model_dir.split('/')[-1], ckpt_name, args.dataset_type))
